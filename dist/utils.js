...
export { isShopifyTheme, writePackageJsonSync, move, isShopifyThemeWhitelistDir, beautifyJson, isShopifyThemeSettingsFile, downloadFromUrl, unzip, getThemeRoot, logger, config };
export default {
  isShopifyTheme,
