...
// build files
task('build', series(util_jobs['clean'], config_jobs["overwrite:build_process"], assets_jobs['build:assets'], svg_jobs['build:svg'], css_jobs['build:css'], js_jobs['build:js'], js_jobs['build:vendor-js']));
